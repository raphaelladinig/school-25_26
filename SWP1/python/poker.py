...
class Card:
    ...
    def __repr__(self):
        """Formale Darstellung, z.B. Card('♠ Pik', 'Ass')"""
        return f"Card('{self.suit}', '{self.rank}')"

    def __str__(self):
        """Freundliche Darstellung, z.B. Ass von ♠ Pik"""
...
class HandEvaluator:
    def __init__(self, cards):
        ...
        self.cards = sorted(cards, reverse=True) # Sortiert von hoch nach niedrig
...
def run_simulation(num_games):
    ...
    for hand_name, count in hand_counts.items():
